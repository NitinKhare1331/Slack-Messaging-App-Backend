...
import { addChannelToWorkspaceService, addMemberToWorkspaceService, createWorkspaceService, deleteWorkspaceService, getWorkspaceByJoinCodeService, getWorkspaceService, getWorkspacesUserIsMemberOfService, joinWorkspaceService, resetJoinCodeService, updateWorkspaceService } from "../service/workspaceService.js";
import {
    customErrorResponse,
...
export const resetJoinCodeController =  async (req, res) => {
  try {
    const response = await resetJoinCodeService(req.params.workspaceId, 
      req.user
    );
    return res
      .status(StatusCodes.OK)
